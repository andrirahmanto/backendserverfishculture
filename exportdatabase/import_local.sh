...
mongoimport --db fishapi --collection fish_transfer --type json --file /Users/andrirahmanto/flask/fishapi/exportdatabase/fish_transfer.json --jsonArray
mongoimport --db fishapi --collection fish_log --type json --file /Users/andrirahmanto/flask/fishapi/exportdatabase/fish_log.json --jsonArray
...
mongoimport --db fishapi --collection fish_grading --type json --file /Users/andrirahmanto/flask/fishapi/exportdatabase/fish_grading.json --jsonArray